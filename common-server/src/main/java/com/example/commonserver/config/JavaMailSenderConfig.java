package com.example.commonserver.config;

import com.example.commonserver.utils.email.EmailProperties;
...
public class JavaMailSenderConfig {
    ...
    public JavaMailSender javaMailSender() {
        ...
        properties.setProperty("mail.smtp.port", Integer.toString(emailProperties.getPort()));
//        properties.setProperty("mail.smtp.socketFactory.port", Integer.toString(111));
