...
import com.example.commonserver.dao.mapper.CommonImageMapper;
import com.example.commonserver.dao.entity.CommonImage;
import com.example.commonserver.utils.oss.OSSUtil;
...
public class ImageServiceImpl implements IImageService {
    ...
    public String saveImage(MultipartFile file) throws IOException {
        ...
        commonImage.setFileType(getFileType(file.getName()));
...
//        ossUtil.delete(commonImage.getFilePath());
    ...
    private static String getFileType(String fileName) {
        ...
        String attachmentType = fileName.substring(lastIndexOf);
