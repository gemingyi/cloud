package com.example.commons.utils.aliyun.sms;//package com.demo.common.utils.aliyun.sms;
//
...
//            LOGGER.info("SmsUtil INFO : 发送短信至 {} - {} - {}", phoneNumbers, code, response.getData());
//            return response.getData();
//        } catch (ServerException e) {
//            LOGGER.error("SmsUtil ServerException : {}", e);
//            e.printStackTrace();
//        } catch (ClientException e) {
//            LOGGER.error("SmsUtil ClientException : {}", e);
//            e.printStackTrace();
//        }
//        return null;
//    }
