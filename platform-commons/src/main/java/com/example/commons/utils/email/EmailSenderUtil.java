...
//     * 带附件
//     */
//    public void sendMail(String toUser, String subject, String message, InputStream excelInputStream, String ioType) {
//        try {
...
//            excel.setFileName("");
//            DataHandler dataHandler = new DataHandler(new ByteArrayDataSource(excelInputStream, ioType));
