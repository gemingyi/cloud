...
public class RSAUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            String publicKeyStr = RSAUtils.getPublicKeyStr(keyMap);
            System.out.println("JAVA生成RSA公钥：" + publicKeyStr);
            String privateKeyStr = RSAUtils.getPrivateKeyStr(keyMap);
            ...
            // 加密测试
            String text = "123abc";
            String s = RSAUtils.encrypt(text, publicKey);
            String s1 = RSAUtils.decrypt(s, privateKey);
            System.out.println(s1);

            // 加密测试2
            String text2 = "123abc";
            String ss = RSAUtils.encrypt(text2, privateKey);
            String ss1 = RSAUtils.decrypt(ss, publicKey);
            System.out.println(ss1);

            // 加签测试
            String str = "aaabbbccc";
            String singe = RSAUtils.privateSinge(str, privateKey);
            boolean b = RSAUtils.publicVerify(str, singe, publicKey);
