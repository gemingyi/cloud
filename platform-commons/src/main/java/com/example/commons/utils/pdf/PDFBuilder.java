...
public class PDFBuilder extends PdfPageEventHelper {
    ...
    public void addWatermark(PdfWriter writer) {
        ...
        Image image;
        try {
            image = Image.getInstance("https://alioss.woaizuji.com/materiel/pic/42384230936193660_9309f4e24dbb43689bd1a79955434e43.png");
            PdfContentByte content = writer.getDirectContentUnder();
            content.beginText();
            // 开始写入水印
            image.setAbsolutePosition(80, 210);
